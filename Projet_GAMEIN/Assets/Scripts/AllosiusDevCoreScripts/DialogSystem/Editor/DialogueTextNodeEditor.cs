            ...
            foreach (GameAction action in gameActions)
            {
                ...
                switch (action.actionType)
                {
                    ...
                    case ActionType.CreatePopupScooter:
                        {
                            action.ScooterPopUpData = (PopUpData)EditorGUILayout.ObjectField("Scooter PopUp Data", action.ScooterPopUpData, typeof(PopUpData), true);
                            break;
                        }
                    ...
                    case ActionType.AddPlayerIcon:
                        {
                            action.iconDataToAdd = (IconData)EditorGUILayout.ObjectField("Icon Data To Add", action.iconDataToAdd, typeof(IconData), true);
                            break;
                        }
                    case ActionType.LaunchShakeCamera:
                        {
                            action.shakeCameraIntensity = EditorGUILayout.FloatField("Shake Camera Intensity", action.shakeCameraIntensity);
