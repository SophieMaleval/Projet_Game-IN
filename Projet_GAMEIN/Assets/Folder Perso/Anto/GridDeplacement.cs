...
public class GridDeplacement : MonoBehaviour
{
    ...
    /*    if(!IsMoving)
        {*/
            ...
            {
                    transform.position = new Vector3(transform.position.x + (InputPlayer.x * Time.deltaTime * 15f), transform.position.y + 0 , transform.position.z) ;
                /* InputPlayer.y = 0 ; */               
            } else
                /* InputPlayer.x = 0; */
                    transform.position = new Vector3(transform.position.x + 0, transform.position.y + (InputPlayer.y * Time.deltaTime * 15f), transform.position.z) ;
